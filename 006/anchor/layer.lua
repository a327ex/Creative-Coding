...
function graphics.polygon(vertices, r, g, b, a, line_width)
  graphics.shape2('polygon', r, g, b, a, line_width, vertices)
end
...
function graphics.shape2(shape, r, g, b, a, line_width, ...)
  r, g, b, a = r or 1, g or 1, b or 1, a or 1
  love.graphics.setColor(r, g, b, a)
  if not line_width then
    love.graphics[shape]('fill', ...)
  elseif line_width then
    if line_width then love.graphics.setLineWidth(line_width) end
    love.graphics[shape]('line', ...)
    love.graphics.setLineWidth(1)
  end
...
function layer:polygon(vertices, r, g, b, a, line_width, z)
  table.insert(self.draw_commands, {type = 'polygon', args = {vertices, r, g, b, a, line_width}, z = z or 0})
end
